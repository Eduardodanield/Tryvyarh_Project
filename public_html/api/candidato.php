...
$htmlEmail =
    ...
    . '<div style="background:#0ECAD4;padding:24px 32px;">'
    ...
    . '<h2 style="color:#0ECAD4;font-size:16px;border-bottom:2px solid #E8FAFB;padding-bottom:8px;margin-top:0;">Dados Pessoais</h2>'
    ...
    . '</table>'
    . '<h2 style="color:#0ECAD4;font-size:16px;border-bottom:2px solid #E8FAFB;padding-bottom:8px;margin-top:24px;">Forma&ccedil;&atilde;o e Interesse</h2>'
    . '<table style="width:100%;border-collapse:collapse;font-size:14px;">'
    ...
    . '</table>'
    . '<h2 style="color:#0ECAD4;font-size:16px;border-bottom:2px solid #E8FAFB;padding-bottom:8px;margin-top:24px;">Curr&iacute;culo</h2>'
